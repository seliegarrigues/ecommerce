...
import bannerImg from '../../assets/people/casual.png'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
          ...
          <div className='flex flex-col justify-center gap-6 sm:pt-0'>
            ...
            <p data-aos='fade-up' className='text-sm text-gray-500 tracking-wide leading-5'>
              ...
              Repellendus laboriosam tempora, commodi iusto atque consequatur laborum qui
              voluptas id asperiores voluptatum dicta
              unde non dolore totam repellat deleniti sequi natus?
            </p>
            <div>
